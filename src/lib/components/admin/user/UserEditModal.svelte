...
<Modal {open} {onclose}>
	...
	<form onsubmit={handleSubmit} class="flex flex-col gap-5 px-8 pb-10">
		...
		<div class="flex flex-col gap-2">
			<label
				for="user-edit-username"
				class="text-outline px-1 text-xs font-black tracking-widest uppercase">{m.username()}</label
			>
			<input
		...
		<div class="flex flex-col gap-2">
			<label
				for="user-edit-password"
				class="text-outline px-1 text-xs font-black tracking-widest uppercase">{m.password()}</label
			>
			<input
		...
		<div class="flex flex-col gap-2">
			<div class="flex justify-between px-1">
				<label
					for="user-edit-email"
					class="text-outline text-xs font-black tracking-widest uppercase">{m.email()}</label
				>
		...
		<div class="flex flex-col gap-2">
			<div class="flex justify-between px-1">
				<div class="flex items-center gap-1.5">
					<label
						for="user-edit-note"
						class="text-outline text-xs font-black tracking-widest uppercase">{m.col_note()}</label
					>
